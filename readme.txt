...
Tags: ordering, posts, custom post types, post order
Requires at least: 3.0
Tested up to: 3.2.1
Stable tag: trunk

Allows for the ordering of posts and custom post types through a simple drag-and-drop interface
...
3. Order posts from the Post Order menu in the admin
...
* Fixed a bug where the sub-post dropdown would show duplicate entries.
